...
//                   style={{ display: "column", gap: "20px", width: "100%", alignItems: "flex-start" }}
//                 >
...
//                 <div
//                   className="card-inner"
//                   style={{ display: "column", gap: "20px", width: "100%", alignItems: "flex-start", flexDirection: "row-reverse" }}
//                 >
      ...
      <div className="max-w-2xl mx-auto text-center px-4">
        ...
        <div className="relative h-48">
          {reviews.map((review, index) => (
            ...
            >
              <p className="text-lg italic mb-3 break-words">"{review.text}"</p>
              <div className="text-yellow-400 mb-3">{"★".repeat(review.rating) + "☆".repeat(5 - review.rating)}</div>
              <h4 className="text-orange-500 font-semibold">- {review.name}</h4>
            </div>
          ))}
...
const About: React.FC = () => {
  ...
  useEffect(() => {
  if (typeof window === "undefined") return;  // Fixed: Check for "undefined" instead of ""
  ...
  return (
    <>
      ...
      <main className="pt-20">
        {/* -------- HERO SECTION WITH JPEG IMAGE -------- */}
        <div
          className="relative h-[420px] md:h-[520px] flex items-center justify-center bg-cover bg-center"
          style={{
            backgroundImage: `url(${heroImage})`,
          }}
        >
          <div className="w-full container mx-auto px-4">
            <div className="text-white max-w-3xl text-center mx-auto">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-5 bg-gradient-to-r from-red-500 to-orange-500 text-transparent bg-clip-text">
                Excellence in Air Conditioning Solutions Since 2007
              </h1>
        ...
        <section id="our-story" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8 text-base sm:text-lg leading-relaxed text-gray-700 break-words">
                <p>
                  With nearly two decades of retail experience, <strong>Supreet Cooling Solutions</strong> is a brand synonymous with unparalleled expertise and unwavering commitment to the highest standards of excellence in the HVAC and Commercial Refrigeration Industry.
                </p>
                <p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-5xl mx-auto space-y-8">
              ...
              <div
                ref={(el) => (cardRefs.current[0] = el)}
                data-dir="left"
                className="founder-card flex flex-col md:flex-row gap-4 bg-gray-50 p-4 sm:p-6 rounded-lg"
              >
                <div className="card-inner flex flex-col md:flex-row gap-4 w-full">
                  <img
                    src={founderImg}
                    alt="Founder Photo"
                    className="w-full sm:w-1/2 md:w-1/3 h-auto object-cover rounded-lg bg-white p-2"
                  />
                  <div className="flex-1">
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Mr. Surinder Bedi</h2>
                    <h4 className="text-base sm:text-lg text-gray-600 mb-4">Founder</h4>
                    <div className="space-y-3 text-sm sm:text-base text-gray-700 break-words">
                      <p>
                        Mr. Surinder Bedi, the visionary founder of Supreet Cooling Solutions,
                        boasts a remarkable career spanning 45 years, marked by dynamic leadership
                        and entrepreneurial prowess.
              ...
              <div
                ref={(el) => (cardRefs.current[1] = el)}
                data-dir="right"
                className="founder-card flex flex-col md:flex-row-reverse gap-4 bg-gray-50 p-4 sm:p-6 rounded-lg"
              >
                <div className="card-inner flex flex-col md:flex-row-reverse gap-4 w-full">
                  <img
                    src={coFounderImg}
                  ...
                  />
                  <div className="flex-1">
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Mr. Mankaran Bedi</h2>
                    <h4 className="text-base sm:text-lg text-gray-600 mb-4">CEO</h4>
                    <div className="space-y-3 text-sm sm:text-base text-gray-700 break-words">
                      <p>
                        Mankaran Bedi, the Co-Founder of Supreet Cooling Solutions, brings to the 
                        forefront two decades of deep market understanding and operational leadership.
        ...
        {/* -------- VISION -------- */}
        <section id="our-vision" className="py-20 bg-gray-100">
